...
\end{table}
  ...
  \end{tabular}
  \caption{Mean fiber execution time (in seconds) in a machine with 2 cores by implementing fibers with User Level Threads in userspace}
